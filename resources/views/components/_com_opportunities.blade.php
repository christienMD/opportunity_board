            ...
            <tr>
              ...
              <td class="max-w-xs">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <div class="font-bold text-lg">{{ $opportunity->title }} (<span class="font-bold text-base">{{ $opportunity->category}}</span>)</div>
               ...
               <td class="flex flex-col gap-3 items-center justify-center text-base capitalize font-medium">
                 <a href="#" class="text-indigo-800 hover:underline w-full">Publish Opportunity</a>
                 <div class="w-full flex gap-3">
                 <a href="#" class="tooltip tooltip-bottom tooltip-error" data-tip="edit opportunity">
                 ...
                 <a href="#" class="tooltip tooltip-bottom" data-tip="view details">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
