...
<div id="mobile-menu" class="lg:hidden hidden" role="dialog" aria-modal="true">
 ...
 <div class="hidden">
  ...
  <div class="relative isolate px-6 lg:px-8">
    <div class="mx-auto max-w-3xl py-28 sm:py-28 lg:py-24">
      <div class="hidden sm:mb-8 sm:flex sm:justify-center">
      
      </div>
      <div class="text-center">
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl w-full">Driving Future Innovations.</h1>
        <p class="mt-6 text-lg leading-8 text-gray-600 ">We pioneer solutions that redefine industries. Our team is dedicated to pushing boundaries and creating value through innovative technology and sustainable practices.</p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="{{ route('company.create') }}" class="rounded-full bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 h-full flex gap-3">Create Opportunity
            <span>
...
<div class="bg-white">
  ...
  @include('components._com_opportunities')
