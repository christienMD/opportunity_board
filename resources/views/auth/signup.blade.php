                  ...
                  >
                        ...
                        <div class="relative">
                          ...
                          type="text" 
                           ...
                           name="phone_number"
                           id="phone_number" 
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full ps-10 p-2.5 " pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890"/>
                        </div>
                @error('phone_number')
                <p class="text-error text-sm">{{$message}}</p>
              @enderror
