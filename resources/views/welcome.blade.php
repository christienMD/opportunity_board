...
@section('header')
 <nav class="flex items-center justify-between h-14 border border-b shadow-md px-6 bg-gradient-to-t from-green-50 to-white">
...
@endsection
@section('hero')
    <div class="flex justify-center items-center bg-gradient-to-t from-indigo-400 to-indigo-white h-[250px]">
            <div class="container mx-auto ">
                ...
                <div class="">
                    ...
                    <span><button class="p-3 border border-indigo-800 rounded-full bg-indigo-800 font-medium text-white hover:bg-indigo-950 transition-colors">Get Started</button></span> </>
                </div>
            </div>
        </div>
    </div>
